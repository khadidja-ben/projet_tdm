...
class MyAdapter(val context: Context,var data:List<Doctor>):RecyclerView.Adapter<MyViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.specility.text = data[position].speciality
...
class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    val specility = view.findViewById<TextView>(R.id.viewSpeciality)
    val localisation = view.findViewById<ImageView>(R.id.localisation)
}
